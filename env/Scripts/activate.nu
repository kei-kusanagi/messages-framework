...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\admin\Desktop\Proyectos\Messages Framework\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\admin\Desktop\Proyectos\Messages Framework\env\Scripts\deactivate.nu'
